    ...
    <section class="top">
        <main class="form-signin">
            <form action="/register" method="post">
                ...
                <div class="form-floating">
                    <input type="Umur" name="umur" class="form-control" id="Umur" placeholder="21">
                ...
                <div class="checkbox mb-3">
                    ...
                    <a style="float:right" href='/register'>Lupa password?</a>
                </div>
                <input class="ml-2" href="/register" type="button" value="Kembali">
